            ...
            <tr>
                ...
                if ($total != 0) {
                    while ($result = mysqli_fetch_assoc($data)) {
                        ...
                        <td><?php echo $result['nozzle_id']; ?></td> 
                        <td><?php echo $result['nozzle_name']; ?></td>
                        <td><?php echo $result['item_name']; ?></td>
                        <td><?php echo "<a href='edit_nozzle?pname=$result[pump_name]&id=$result[nozzle_id]&name=$result[nozzle_name]&iname=$result[item_name]'>Edit</a>"; ?></td>
                        <td><?php echo "<a href='delete_nozzle?id=$result[nozzle_id]'>Delete</a>"; ?></td>
                    </tr>
                    <?php
                }
            } else {
